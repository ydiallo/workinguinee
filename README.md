...
- workinguinee-addon: addon module, custom server and client side code 
- workinguinee-ui: main application module
- workinguinee-backend: backend module, contains any server side java code and dependencies
